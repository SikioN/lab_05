...
public class Town {
    ...
    public static Town.Place request(){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Введите тип локации (GIGANTIC_PLANT_SOCIETY, BANK, STREET)");
        String line = scanner.nextLine();
        TypeOfLocation typeOfLocation = TypeOfLocation.valueOf(line);
        ...
        return new Place(typeOfLocation, x, y);
    }
